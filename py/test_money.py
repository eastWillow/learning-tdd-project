...
class TestMoney(unittest.TestCase):
    ...
    def testAddition(self):
        ...
        self.assertEqual(fifteenDollars, portfilo.evaluate(self.bank, "USD"))
    ...
    def testAdditionOfDollarsAndEuros(self):
        ...
        actualValue = portfilo.evaluate(self.bank, "USD")
        self.assertEqual(
    ...
    def testAdditionOfDollarsAndWons(self):
        ...
        actualValue = portfilo.evaluate(self.bank, "KRW")
        self.assertEqual(
            expectedValue, actualValue, "%s != %s" %(expectedValue, actualValue)
        )
    ...
    def testAdditionWithMultipleMissingExchangeRates(self):
        ...
        with self.assertRaisesRegex(
            ...
            portfilo.evaluate(self.bank, "Kalganid")
